...
export default function Navbar() {
  ...
  const tabBase =
    'relative inline-flex items-center gap-2 px-3 py-2 rounded-lg font-medium text-slate-900 transition-[transform,background,color,box-shadow] duration-200 ease-out';
  const tabHover =
    'hover:bg-white/70 hover:shadow-sm hover:-translate-y-[1px] hover:text-black';
  const tabUnderline =
  ...
  return (
    <nav className="sticky top-20 z-40 bg-zinc-800/80 backdrop-blur-md border-b border-white/40 shadow-[0_1px_10px_rgba(0,0,0,0.05)]">
